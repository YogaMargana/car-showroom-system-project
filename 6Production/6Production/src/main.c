...
int main(void) {
    ...
    while (!WindowShouldClose() && jalan) {
        ...
        DrawLineEx(
            ...
            (Vector2){ dividerX, (float)app.screenH},
            5.0f,
            WHITE
        );
        ...
        switch (app.halamanSekarang) {
            ...
            case HAL_DASHBOARD_ADMIN:
                DrawText("Admin Dashboard", (int)rightArea.x + 40, 120, 28, WHITE);
                DrawText("Select the menu on the left to manage master data / reports.",
            ...
            case HAL_DASHBOARD_CASHIER:
                DrawText("Cashier Dasboard", (int)rightArea.x + 40, 120, 28, WHITE);
                DrawText("Select the menu on the left to manage car and accessory sales.",
                         (int)rightArea.x + 40, 160, 18, WHITE);
                break;
            ...
            case HAL_DASHBOARD_SALES:
                DrawText("Sales Dashboard", (int)rightArea.x + 40, 120, 28, WHITE);
                DrawText("Select the menu on the left to manage Test Drives and Customers.",
                         (int)rightArea.x + 40, 160, 18, WHITE);
                break;
